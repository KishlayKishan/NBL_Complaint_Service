...
public class RegionController {
    ...
    @Autowired
    private AdminService regionService;
    ...
    public String loginUser(@ModelAttribute Region region, HttpServletRequest request ,HttpSession httpSession) {
        Region regionLoginCheck=regionService.findByUsernameAndPassword(region.getUsername(), region.getPassword());
    ...
    public String showAllComplaints(HttpServletRequest request ) {
        request.setAttribute("complaints", regionService.showAllComplaints());
    ...
    public String deleteComplaint(@RequestParam String id, HttpServletRequest request ) {
        ...
        request.setAttribute("complaint", regionService.showAllComplaints());
        request.setAttribute("mode", "All_COMPLAINTS");
        return "complaints";
